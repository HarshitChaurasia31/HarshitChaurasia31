...
<img align="right" width="360" src="https://user-images.githubusercontent.com/74038190/212284100-561aa473-3905-4a80-b561-0d28506553ee.gif" alt="coding gif" />

I'm a **Full Stack Developer** who loves turning ideas into fast, elegant, and scalable digital products. My core focus areas include:

- 🚀 **Full Stack Development** — building end-to-end applications with clean architecture
- ⚛️ **React** — crafting responsive, component-driven, modern UIs
- 🟢 **Node.js** — designing robust and scalable backend systems
- 🤖 **Artificial Intelligence** — integrating AI/LLM capabilities into real-world products
- 🐳 **Docker** — containerizing applications for consistent, production-ready deployments
- 🎨 **Modern UI/UX** — building interfaces that feel smooth, intuitive, and alive with animation
- 📚 **Continuous Learning** — always exploring new tools, patterns, and system design concepts

I care deeply about writing clean code, designing thoughtful systems, and building products that are both performant and delightful to use.
...
| Area | Details |
|------|---------|
| 🎞️ Animation | GSAP, Framer Motion, Three.js |
| 🧠 Backend | Advanced Node.js patterns, microservices |
| 🏗️ System Design | Scalability, distributed systems |
...
A headless CMS built for developers to manage portfolio content with a clean admin panel and GraphQL API.

`Next.js` `GraphQL` `MongoDB` `Node.js`

<a href="https://github.com/YOUR_USERNAME/project-four"><img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" /></a>
<a href="https://your-live-demo-link.com"><img src="https://img.shields.io/badge/Live_Demo-000000?style=flat-square&logo=vercel&logoColor=white" /></a>
...
| | |
|---|---|
| 🧩 | I enjoy solving system design problems as much as writing code |
...
| 📖 | Always reading about the latest in AI and web development |
